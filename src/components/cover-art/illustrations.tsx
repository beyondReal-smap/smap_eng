// CoverArt SVG 일러스트 모음 — 24종 템플릿(+ Svg 래퍼).
// 각 컴포넌트는 props 없이 고정 SVG를 반환하며, seeded 색은 부모 CoverArt가
// 설정한 --c1~--c3 CSS 변수에서 상속받는다. CoverArt(cover-art.tsx)가 import해 분기 렌더.
